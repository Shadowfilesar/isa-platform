...
<div class="p-10">
    <div class="mb-8">
        ...
        <div class="mt-5 text-sm text-slate-500">
            ...
            <span class="mx-2">/</span>
            <span class="text-amber-400">Create Case</span>
        </div>
    </div>
    ...
    <div class="mb-10">
        ...
        <p class="mt-2 text-slate-500">
            Register a new case record for the ISA investigation system.
        </p>
    </div>
            ...
            <div class="space-y-6">
                <div class="rounded-2xl border border-slate-800 bg-slate-950/50 p-6">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-500">
                        Decide whether this case should be available immediately after creation.
                    </p>
                        ...
                        <label class="flex items-start gap-4 rounded-lg border border-slate-700 bg-slate-900 p-5 transition hover:border-amber-500">
                            ...
                            <div>
                                ...
                                <div class="mt-1 text-sm text-slate-500">
                                    Uncheck to keep this case in draft mode.
                                </div>
                            </div>
                        </label>
                    </div>
                ...
                <div class="rounded-2xl border border-slate-800 bg-slate-950/50 p-6">
                    ...
                    <ul class="mt-4 space-y-3 text-sm leading-6 text-slate-400">
                        <li>Use a unique case code.</li>
                        <li>Keep titles clear and mission-focused.</li>
                        <li>Description is optional but recommended.</li>
                        <li>Difficulty must remain Easy, Medium, or Hard.</li>
                    </ul>
                </div>
            </div>
        </div>
