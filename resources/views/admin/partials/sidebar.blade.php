...
<aside
    ...
    <nav class="flex-1 space-y-2 px-4 py-6">
        ...
        <a
            ...
            class="block rounded-lg px-4 py-3 font-semibold {{ request()->routeIs('admin.messages.*') ? 'bg-amber-600 text-white' : 'text-slate-300 hover:bg-slate-900 hover:text-white' }}">
            Director Messages
        </a>
